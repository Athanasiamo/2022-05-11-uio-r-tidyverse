...
humandate: "April 11 and April 12, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Alina Sartorius", "Asbjørn Holmgren", "Luis Cadahia-Lorenzo"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]email: ["contact-us@swcarpentry.uio.no"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
